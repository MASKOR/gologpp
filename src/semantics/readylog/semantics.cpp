...
DEFINE_MAKE_IMPL(InitialValue<BooleanExpression>)
DEFINE_MAKE_IMPL(InitialValue<NumericExpression>)
...
DEFINE_MAKE_IMPL(Quantification)

DEFINE_MAKE_IMPL(Block)
DEFINE_MAKE_IMPL(Choose)
DEFINE_MAKE_IMPL(Conditional)
DEFINE_MAKE_IMPL(Assignment<BooleanFluent>)
DEFINE_MAKE_IMPL(Assignment<NumericFluent>)
DEFINE_MAKE_IMPL(Assignment<BooleanVariable>)
DEFINE_MAKE_IMPL(Assignment<NumericVariable>)
DEFINE_MAKE_IMPL(Pick<BooleanExpression>)
DEFINE_MAKE_IMPL(Pick<NumericExpression>)
DEFINE_MAKE_IMPL(Search)
DEFINE_MAKE_IMPL(Solve)
